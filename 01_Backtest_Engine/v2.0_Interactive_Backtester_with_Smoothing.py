...
class PortfolioBacktester:
    ...
    def run_backtest(self, start_date, end_date):
        ...
        plt.plot(normalized_comparison.index, normalized_comparison['S&P 500'], label='S&P 500', linewidth=2, color='darkgray', linestyle='-', alpha=0.3)  # 원본 데이터 (투명하게)
        ...
        plt.plot(normalized_comparison.index, normalized_comparison['KOSPI'], label='KOSPI', linewidth=2, color='lightgrey', linestyle='-', alpha=0.3)  # 원본 데이터 (투명하게)
